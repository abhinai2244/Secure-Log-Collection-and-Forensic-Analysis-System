...
class RealLogCollector:
    ...
    """
    def __init__(self, log_chain: LogChain, detection_engine=None, ips_manager=None):
        ...
        try:
            ...
            for event in data:
                ...
                if self.detector:
                    ...
                    if is_attack:
                        self.alerts.append({"type": attack_type, "details": full_message, "risk_score": score, "block_index": block.index})
